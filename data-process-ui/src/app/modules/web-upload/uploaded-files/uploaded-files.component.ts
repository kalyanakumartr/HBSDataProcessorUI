...
export class UploadFilesComponent implements
OnInit,
OnDestroy,
IDeleteAction,
...
authModel:AuthModel;
  constructor(private fb: FormBuilder,
    private modalService: NgbModal, public webUploadService: WebUploadService) {
  ...
  ngOnInit(): void {
    ...
    this.webUploadService.fetch("/searchWebUpload");
  ...
  filter() {
    ...
    this.webUploadService.patchState({ filter },"/searchWebUpload");
  }
  ...
  search(searchTerm: string) {
    this.webUploadService.patchState({ searchTerm },"/searchWebUpload");
  }
  ...
  sort(column: string) {
    ...
    this.webUploadService.patchState({ sorting },"/searchWebUpload");
  }

  // pagination
  paginate(paginator: PaginatorState) {
    this.webUploadService.patchState({ paginator },"/searchWebUpload");
  }
  // form actions
