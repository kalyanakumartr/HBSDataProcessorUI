...
@Component({
  selector: 'app-wu-delivery-list',
  templateUrl: './wu-delivery-list.component.html',
  styleUrls: ['./wu-delivery-list.component.scss']
})
export class WuDeliveryListComponent implements OnInit,
OnDestroy,
IDeleteAction,
IDeleteSelectedAction,
IFetchSelectedAction,
